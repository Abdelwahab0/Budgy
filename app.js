...
var budgetController = (function(){
	...
	return {
		addItem:function(type, des, val){
			...
			//Creating new item bassed on 'inc' or 'exp' type
			if (type === 'exp'){
		...
		calaculatePercentages: function(){
...
var UIController = (function(){
	...
	return{
		...
		//Create HTML string with placeholder texxt
...
var controller = (function(budgetCtrl,UIctrl){
	...
	//Handling the return key 'Enter' keyCode:13// which in older browsers
	...
	var ctrlAddItem = function(){
		...
		//Making sure the fields are not empty etc
